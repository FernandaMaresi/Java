...
public class telaCalc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/superCalculadora.JPG"))); // NOI18N

        btnCalc.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btnCalc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/calcBotao.JPG"))); // NOI18N
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        //fomatada 4 númeos raiz
        lblRaizQ.setText(String.format("%.4f",rq));
        
        //RAIZ CÚBLICA
        double rc = Math.cbrt(num);
        //lblRaizCubica.setText(Double.toString(rc));
        //fomatada 2 númeos cubica
